      ...
      <div className="w-full max-w-6xl bg-white rounded-lg shadow-2xl overflow-hidden flex min-h-[600px]">
        ...
        <div className="w-1/2 p-12 flex items-center">
          <div className="max-w-md w-full mx-auto">
            ...
            {/* EMAIL */}
            <div className="mb-5">
              <label className="block text-sm text-gray-700 font-serif mb-2">
                Email id
              </label>
              <input
                type="email"
                ...
                className="w-full px-4 py-3 rounded-full border-2 border-gray-300 focus:outline-none focus:border-gray-400 text-sm text-black"
              />
            </div>
            ...
            <div className="mb-8">
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full px-4 py-3 pr-12 rounded-full border-2 border-gray-300 focus:outline-none focus:border-gray-400 text-sm text-black"
                />
                <button
                  type="button"
            ...
            <div className="flex justify-center items-center">
              <button
                ...
                className="w-40 bg-red-800 hover:bg-red-900 text-white py-3 rounded-2xl font-medium transition mb-4"
              >
                Login
              </button>
            </div>
